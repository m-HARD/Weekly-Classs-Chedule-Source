  ...
  data() {
    return {
      ...
      mainData:{
        ...
        classes:[
          {id:1,name:'اولى أ',subInDay:6},
          {id:2,name:'تانية أ',subInDay:6},
          {id:3,name:'تالتة أ',subInDay:6},
          {id:4,name:'رابعة أ',subInDay:6},
          {id:5,name:'خامسة أ',subInDay:7},
          {id:6,name:'سادسة أ',subInDay:7},
          {id:7,name:'أولى متوسط أ',subInDay:7},
          {id:8,name:'اولى ب',subInDay:6},
          {id:9,name:'تانية ب',subInDay:6},
          {id:10,name:'تالتة ب',subInDay:6},
