    ...
    return {
      ...
      mainData:{
        ...
        teachers:[
          ...
          {id:4,name:'دعاء محمد'},
          {id:5,name:'سهير حسن'},
          {id:6,name:'اخت سهير حسن'},
          {id:7,name:'سحر محمد'},
          {id:8,name:'مناهل عباس'},
          {id:9,name:'ام المؤمنين'},
          {id:10,name:'الشيماء احمد'},
          {id:11,name:'صفاء الحافظ'},
          {id:12,name:'درية'},
          {id:13,name:'ماجدة تاور'},
          {id:14,name:'إسراء صديق'},
          {id:15,name:'شادية الريح'},
          {id:16,name:'عازة عمر'},
